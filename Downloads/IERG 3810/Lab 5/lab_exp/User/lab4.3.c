...
/* key2 has higher priority than keyUp */
/* if keyUp pressed during key2, DS1 blinks 10 times after DS0 finishes */
/* if key2 pressed during keyUp, DS0 blinks 10 times and then DS1 finish blinking the rest */